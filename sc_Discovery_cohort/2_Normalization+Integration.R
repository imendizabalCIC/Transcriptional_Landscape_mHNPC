...
# Run UMAP
data_integrated <- RunUMAP(data_integrated, dims = 1:13, reduction = "pca", min.dist = 0.6)
...
## Cluster the cells 
##################################################
data_integrated <- FindNeighbors(object = data_integrated, dims = 1:13)

# Determine the clusters                               
data_integrated <- FindClusters(object = data_integrated, resolution = 0.8)
